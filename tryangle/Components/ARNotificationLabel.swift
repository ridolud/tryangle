...
class ARNotificationLabel: UILabel {
    ...
    override func didMoveToSuperview() {
        ...
        self.backgroundColor = #colorLiteral(red: 0.03175527975, green: 0.006974271964, blue: 0.01176777016, alpha: 0.6491331336)
...
//            self.isShowUp = true
//            self.transform = CGAffineTransform(translationX: 0, y: 109)
